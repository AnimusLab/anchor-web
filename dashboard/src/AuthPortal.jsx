...
export default function AuthPortal({ isInvite = false }) {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      const randomSuffix = Math.random().toString(16).substring(2, 4);
      ...
      <div style={{ flex: 1, display: 'flex', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1.2, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px', position: 'relative', zIndex: 10 }}>
          <div style={{ width: '100%', maxWidth: 440 }}>
                ...
                {loginStep === 'identify' ? (
                  <>
                    ...
                    <Field label="Organization Hub ID">
                      <input required autoComplete="off" type="text" name="orgId" value={formData.orgId} onChange={handleInputChange}
            ...
            <div style={{ marginTop: 24, paddingTop: 20, borderTop: '1px solid #1f2937', color: '#4b5563', fontSize: 10, fontFamily: 'JetBrains Mono, monospace', textAlign: 'center' }}>
