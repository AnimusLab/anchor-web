          ...
          <form onSubmit={handleLoginSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full bg-black/60 border border-white/20 rounded-2xl pl-6 pr-4 py-3.5 text-white text-sm font-sans placeholder:text-slate-500 placeholder:opacity-50 focus:outline-none focus:border-rose-400 focus:ring-2 focus:ring-rose-500/30 transition shadow-inner leading-normal"
              />
            </div>
