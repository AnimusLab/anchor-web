    ...
    <div className="space-y-8 max-w-6xl mx-auto relative z-10">
      ...
      <div className="glass-card p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="text-right font-mono text-xs text-slate-300">
          ...
          <span className="text-amber-400 font-bold glass-badge px-3.5 py-1.5 inline-block">
            GOVERNMENT AUDITOR (RBI)
          </span>
        </div>
      </div>

      {/* Glassmorphism KPI Blocks (No Drop Shadow) */}
      ...
      {/* Decision Audit Log Stream (Glassmorphism Card) */}
